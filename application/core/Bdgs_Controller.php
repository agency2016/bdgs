...
class Bdgs_Controller extends CI_Controller {
    ...
    public $default_load_list = array(
        'bdgs_css' => array('bootstrap', 'font-awesome','sweetalert','jquery-ui','animate','bdgs','trumbowyg','hover','jssocials','jssocials-theme-flat','jquery.dataTables.min'),
        'bdgs_js' => array('jquery-1.9.1.min', 'jquery.validate', 'jquery-ui.min', 'bootstrap','sweetalert.min','trumbowyg','jssocials','jquery.dataTables.min'),
        'bdgs_font' => array(),
