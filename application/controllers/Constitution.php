...
class Constitution extends Bdgs_Controller {
    ...
    public function c_list() {
        ...
        $data['record'] = $this->Bdgs_model->get_all('constitution');
        //var_dump($data);exit;
        $css_js_for_home = array();
        $this->_render_admin('constitution/constitution', $data, $css_js_for_home);
    }
    ...
    public function add() {
        ...
        if ($this->form_validation->run() == FALSE) {
            ...
            $data['get_insert_id'] = $this->Bdgs_model->insert('constitution',$data);
    ...
    public function delete() {
        ...
        $data['get_insert_id'] = $this->Bdgs_model->delete('constitution',array('id'=>$id));
        echo "deleted";
    }
    /**
     * 
    ...
    public function edit() {
        ...
        if ($this->form_validation->run() == FALSE) {
            ...
            $data['get_edit_id'] = $this->Bdgs_model->update('constitution', $data,array('id'=>$_id));
        }
    }
