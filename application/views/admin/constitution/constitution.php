...
<div class="container-fluid">
        <div class="row">
            ...
            <div class="col-md-9">
                ...
                <h1 class="text-center custom_heading">Constitution</h1>
               
                    <button class="btn btn-primary" data-title="Add" data-toggle="modal" data-target="#add" ><span class="glyphicon glyphicon-plus"></span> Constitution</button>
...
<script>
    function add_aboutus() {
        ...
        $.ajax({
            type: 'POST',
            url: '<?php echo base_url(); ?>index.php/Constitution/add',
            data: user_data,
            async: false,
    ...
    function delete_item(pid) {
        ...
        $('#delet_confirm').on('click', function (e) {
            ...
            if (sure == 1) {
                $.ajax({
                    type: 'POST',
                    url: '<?php echo base_url(); ?>index.php/Constitution/delete',
                    data: {edit_id: pid},
                    async: false,
                    success: function (result) {
                        $("#delete").modal('hide');
    ...
    function update_item(item) {
        ...
        $('#update_confirm_click').click(function () {
            ...
            $.ajax({
                type: 'POST',
                url: '<?php echo base_url(); ?>index.php/Constitution/edit',
                data: user_data,
                async: false,
                success: function (result) {
                    if (result) {
